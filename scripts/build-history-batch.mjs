...
const batchConfigs = {
  ...
  "2025-q1": {
    ...
    venueSeedFiles: [
      "research/history-venue-seeds-2025-q1.json",
      "research/history-venue-seeds-2021-2022.json",
      "research/history-venue-seeds-2023-q1.json",
      "research/history-venue-seeds-2023-q2.json",
      "research/history-venue-seeds-2023-q3.json",
    ...
    outputFile:
      "research/history-batch-2025-q1.json",
    extrasFile: null,
    includes: event =>
      event.startDate >= "2025-01-01" &&
      event.startDate <= "2025-03-31",
    summaryYears: ["2025"]
  },
  "2025-q2": {
    label: "2025年4～6月",
    checkedAt: "2026-08-28",
    venueSeedFiles: [
      "research/history-venue-seeds-2025-q2.json",
      "research/history-venue-seeds-2021-2022.json",
      "research/history-venue-seeds-2023-q2.json",
      "research/history-venue-seeds-2023-q3.json",
      "research/history-venue-seeds-2023-q4.json",
    ...
    outputFile:
      "research/history-batch-2025-q2.json",
    extrasFile: null,
    includes: event =>
      event.startDate >= "2025-04-01" &&
      event.startDate <= "2025-06-30",
    summaryYears: ["2025"]
  },
  "2025-q3": {
    label: "2025年7～9月",
    ...
    outputFile:
      "research/history-batch-2025-q3.json",
    extrasFile: null,
    includes: event =>
      event.startDate >= "2025-07-01" &&
  ...
  "2025-q4": {
    ...
    outputFile:
      "research/history-batch-2025-q4.json",
    extrasFile: null,
    includes: event =>
      event.startDate >= "2025-10-01" &&
      event.startDate <= "2025-12-31",
    summaryYears: ["2025"]
  },
  "2026-q1": {
    label: "2026年1～3月",
    checkedAt: "2026-08-28",
    venueSeedFiles: [
      "research/history-venue-seeds-2026-q1.json",
      "research/history-venue-seeds-2021-2022.json",
      "research/history-venue-seeds-2023-q1.json",
      "research/history-venue-seeds-2023-q3.json",
      "research/history-venue-seeds-2024-q1.json",
    ...
    outputFile:
      "research/history-batch-2026-q1.json",
    extrasFile: null,
    includes: event =>
      event.startDate >= "2026-01-01" &&
